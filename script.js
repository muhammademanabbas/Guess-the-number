...
buttons.forEach((v , i)=>{
    ...
    reset.addEventListener('click' ,  ()=>{
        ...
        playerNumber    =   undefined  ; 
        howManyAttempt  = 0 ;
        attempt_1.style.backgroundColor = '#ffffff' ;
        attempt_2.style.backgroundColor = '#ffffff' ;
        attempt_3.style.backgroundColor = '#ffffff' ;
        attempt_4.style.backgroundColor = '#ffffff' ;
